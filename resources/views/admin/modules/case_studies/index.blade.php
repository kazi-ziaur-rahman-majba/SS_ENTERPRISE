                ...
                <div class="col-xl-12">
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            ...
                            <hr>
                            <form class="row g-3"
                                @if (isset($data)) action="{{ route('case-studies.update', [$data->id]) }}" 
                                
                            @else
                                action="{{ route('case-studies.store') }}" @endif
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="category_id" class="form-select">
                                        ...
                                        @if (isset($caseStudiesCategory))
                                            @foreach ($caseStudiesCategory as $row)
                                                <option
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="name" name="client_name"
                                        @if (isset($data)) value="{{ $data->client_name }}" @endif >
                                </div>
                                <div class="col-md-12">
                                    <label for="location" class="form-label">Location</label>
                                    <input type="text" class="form-control" id="name" name="location"
                                        @if (isset($data)) value="{{ $data->location }}" @endif >
                                </div>
                                <div class="col-md-6">
                                    <label for="completed_date" class="form-label">Completed date</label>
                                    <input type="month" class="form-control" id="name" name="completed_date"
                                        @if (isset($data)) value="{{ $data->completed_date }}" @endif >
                                </div>
                                <div class="col-md-6">
                                    <label for="project_value" class="form-label">Project value</label>
                                    <input type="text" class="form-control" id="name" name="project_value"
                                        @if (isset($data)) value="{{ $data->project_value }}" @endif >
                                </div>
                                <div class="col-md-12">
