    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                ...
                <div class="ms-auto">
                    <div class="">
                        <a class="btn btn-primary split-bg-primary" href="{{ route('case-studies.create') }}">Create New</a>
                    </div>
                </div>
            </div>
                                        ...
                                        @if (count($data) > 0)
                                            @foreach ($data as $key => $item)
                                                <tr>
                                                    ...
                                                    <td class="d-flex">
                                                        <a href="{{ route('case-studies.edit', [$item->id]) }}"
                                                            class="btn btn-sm btn-outline-primary m-1">
                                                            <i class="bx bx-edit-alt me-0"></i>
                                                        </a>
                                                        <form
                                                            action="{{ route('case-studies.destroy', [$item->id]) }}"
