        ...
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Blog Category CMS</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">All Blog Category List</h4>
                ...
                <div class="col-lg-6  mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row g-3"
                                @if (isset($edit)) action="{{ route('blog-category.update', [$edit->id]) }}" 
                                    
                                @else
                                    action="{{ route('blog-category.store') }}" @endif
