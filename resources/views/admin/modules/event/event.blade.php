                ...
                <div class="col-xl-12">
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            ...
                            <hr>
                            <form class="row g-3"
                                @if (isset($data)) action="{{ route('event.update', [$data->id]) }}" 
                                
                            @else
                                action="{{ route('event.store') }}" @endif
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control" id="name" name="event_date"
                                        @if (isset($data)) value="{{ $data->event_date }}" @endif required>
                                </div>
                                <div class="col-md-6">
                                    <label for="event_time" class="form-label">Event time</label>
                                    <input type="text" class="form-control" id="name" name="event_time"
                                        @if (isset($data)) value="{{ $data->event_time }}" @endif required>
                                </div>
                                <div class="col-md-12">
                                    <label for="location" class="form-label">Event location</label>
                                    <input type="text" class="form-control" id="name" name="location"
                                        @if (isset($data)) value="{{ $data->location }}" @endif required>
                                </div>
                                <div class="col-md-12">
