        ...
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Gallery Category CMS</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">All Gallery Category List</h4>
                                        ...
                                        @if (count($data) > 0)
                                            @foreach ($data as $key => $item)
                                                <tr>
                                                    ...
                                                    <td>{{ $item->name }}</td>
                                                    <td class="d-flex">
                                                        <a href="{{ route('gallery-category.edit', [$item->id]) }}"
                                                            class="btn btn-sm btn-outline-primary m-1">
                                                            <i class="bx bx-edit-alt me-0"></i>
                                                        </a>
                                                        <form action="{{ route('gallery-category.destroy', [$item->id]) }}"
                ...
                <div class="col-lg-6  mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row g-3"
                                @if (isset($edit)) action="{{ route('gallery-category.update', [$edit->id]) }}" 
                                    
                                @else
                                    action="{{ route('gallery-category.store') }}" @endif
