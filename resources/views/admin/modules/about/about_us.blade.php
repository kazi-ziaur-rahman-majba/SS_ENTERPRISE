                ...
                <div class="col-xl-12">
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            ...
                            <hr>
                            <form class="row g-3"
                                @if (isset($data)) action="{{ route('about-us.update', [$data->id]) }}" 
                                    
                                @else
                                    action="{{ route('about-us.store') }}" @endif
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="about_title" name="about_title"
                                        @if (isset($data)) value="{{ $data->about_title }}" @endif required>
                                </div>
                                <div class="col-md-12">
                                    <label for="about_details" class="form-label">About detail</label>
                                    <textarea name="about_details" id="mytextarea" rows="5" class="form-control">
                                        @if (isset($data))
{{ $data->about_details }}
@endif
                                    </textarea>
                                ...
                                <div class="col-md-12">
                                    <label for="title" class="form-label">About Image</label>
                                    <div class="form-group">
                                        @if (isset($data))
                                            @php
                                                $about_image = json_decode($data->about_image, true);
                                            @endphp
                                        @endif
                                        <table class="table table-bordered">
                                            ...
                                            <tbody class="clonetable">
                                                @if (isset($about_image))
                                                    @foreach ($about_image as $key => $item)
                                                        <tr>
