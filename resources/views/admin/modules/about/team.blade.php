        ...
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Team CMS</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">All Team Menber List</h4>
                ...
                <div class="col-lg-6  mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Add New Team Menber</h4>

                            <form class="row g-3"
                                @if (isset($edit)) action="{{ route('team.update', [$edit->id]) }}" 
                                    
                                @else
                                    action="{{ route('team.store') }}" @endif
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="destination" name="destination"
                                            ...
                                            @if (isset($edit)) value="{{ $edit->destination }}" @endif>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <label for="image" class="form-label">Image: [ Size - 370 X 430, Max
                                        Limit
                                        200KB ]
                                    </label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="facebook_link" name="facebook_link"
                                        placeholder="Enter facebook link" @if (isset($edit)) value="{{ $edit->facebook_link }}" @endif>
                                </div>
                                <div class="col-md-6">
                                    <label for="twitter_link" class="form-label">twitter Link</label>
                                    <input type="text" class="form-control" id="twitter_link" name="twitter_link"
                                        placeholder="Enter twitter Link" @if (isset($edit)) value="{{ $edit->twitter_link }}" @endif
                                        >
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="linkedin_link" name="linkedin_link"
                                        placeholder="Enter linkedink Link" @if (isset($edit)) value="{{ $edit->linkedin_link }}" @endif
                                        >
                                </div>
                                <div class="col-md-6">
                                    <label for="instagram_link" class="form-label">Instagram Link</label>
                                    <input type="text" class="form-control" id="instagram_link" name="instagram_link"
                                        placeholder="Enter instagram Link" @if (isset($edit)) value="{{ $edit->instagram_link }}" @endif
                                        >
                                </div>
                                <div class="col-12">
