                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Contact Messages List</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                        ...
                                        @if (count($data) > 0)
                                            @foreach ($data as $key => $item)
                                                <tr>
                                                    ...
                                                    <td class="d-flex">
                                                        <a href="{{ route('contact-list.show', [$item->id]) }}"
                                                            class="btn btn-outline-primary m-1">
                                                            <i class="bx bx-show me-0"></i>
                                                        </a>
                                                        <form action="{{ route('contact-list.destroy', [$item->id]) }}"
