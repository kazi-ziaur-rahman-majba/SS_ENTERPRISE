    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                ...
                <div class="ms-auto">
                    <div class="">
                        <a class="btn btn-primary split-bg-primary" href="{{ route('career.create') }}">Create New</a>
                    </div>
                </div>
            </div>
                                        ...
                                        @if (count($data) > 0)
                                            @foreach ($data as $key => $item)
                                                <tr>
                                                    ...
                                                    <td>{{ date('F j, Y', strtotime($item->deadline)) }}</td>
                                                    ...
                                                    <td class="d-flex">
                                                        ...
                                                        <form
                                                            action="{{ route('career.destroy', [$item->id]) }}"
